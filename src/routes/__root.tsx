...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VPNSUS — бесплатные VPN-конфигурации" },
      { name: "description", content: "VPNSUS — менеджер бесплатных VPN-конфигураций VLESS." },
      { name: "theme-color", content: "#10131F" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { property: "og:title", content: "VPNSUS — бесплатные VPN-конфигурации" },
      { property: "og:description", content: "VPNSUS — менеджер бесплатных VPN-конфигураций VLESS." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "VPNSUS — бесплатные VPN-конфигурации" },
      { name: "twitter:description", content: "VPNSUS — менеджер бесплатных VPN-конфигураций VLESS." },
