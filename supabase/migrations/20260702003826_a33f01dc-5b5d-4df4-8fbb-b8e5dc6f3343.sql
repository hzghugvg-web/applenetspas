...
CREATE INDEX IF NOT EXISTS idx_vless_links_availability
  ON public.vless_links (direction_id, is_active, available_from, expires_at);

CREATE OR REPLACE FUNCTION public.cleanup_expired_vless_links()
RETURNS integer
LANGUAGE plpgsql
SECURITY DEFINER
...
GRANT EXECUTE ON FUNCTION public.cleanup_expired_vless_links() TO authenticated;
GRANT EXECUTE ON FUNCTION public.cleanup_expired_vless_links() TO service_role;
